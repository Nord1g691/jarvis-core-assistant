      ...
      this._onMessage = async (ev) => {
        ...
        try {
          ...
          if (msg.type === "get_states") {
            ...
            result = await this._hass.callService(msg.domain, msg.service, msg.service_data || {});
          } else if (msg.type === "jarvis/get_panel_data") {
            result = await this._panelData();
      ...
      if (match && method === "POST") {
        ...
        return {
          ...
          body: await this._hass.callService(
            ...
            data.service_data || data.data || data,
          ),
        };
      }
