(() => {
  "use strict";
  const HUD = "https://nord1g691.github.io/jarvis-core-assistant/index.html?v=9.5.1";
  ...
  class JarvisPanel extends HTMLElement {
    ...
    render() {
      ...
      this._onMessage = async (ev) => {
        ...
        try {
          ...
          else if (msg.type === "jarvis/get_panel_data") result = { entity_count: Object.keys(this._hass.states || {}).length, states: Object.values(this._hass.states || {}) };
        ...
        } catch (e) { this._reply(m.id, { error: e?.message || String(e), success: false }); }
      };
    ...
    async _httpRequest(msg) {
      ...
      if (method === "GET" && (path === "/api/" || path === "/api/config")) return { status: 200, body: await this._hass.callWS({ type: "get_config" }) };
